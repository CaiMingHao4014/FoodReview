...
public class ThirdActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etTitle = (EditText) findViewById(R.id.etFood);
        etSingers = (EditText) findViewById(R.id.etSingers);
        etYear = (EditText) findViewById(R.id.etYear);
        ratingBar = findViewById(R.id.ratingbarStars);

        Intent i = getIntent();
        final Song currentSong = (Song) i.getSerializableExtra("food");
        ...
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Toast.makeText(ThirdActivity.this, "Invalid code", Toast.LENGTH_SHORT).show();
                    return;
                }
